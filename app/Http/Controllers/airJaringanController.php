...
class airJaringanController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if($request->lok == 1){
            $airJaringan = airJaringan::where('kd_kab', 855)->orWhere('kd_kab', 800)->get();
            $lokasi = 'Kampus I - Limau Manih';
        }elseif($request->lok==2){
            $airJaringan = airJaringan::where('kd_kab', 856)->orWhere('kd_kab', 803)->get();
            $lokasi = 'Kampus II - Payakumbuh';
        }else{
            $airJaringan = airJaringan::where('kd_kab', 0)->get();
            $lokasi = 'Kampus III Darmasraya';
        }
//        }


        return view('backend.asset.air_jaringan.list_lokasi',compact('airJaringan', 'lokasi','lok'));
    ...
    {
        $data = airJaringan::where('id',$id)->first();
        ...
        return view('backend.asset.air_jaringan.detail',compact('data','kab','manfaat', 'biaya_manfaat','biaya_pemeliharaan','pelihara','pindah'));
