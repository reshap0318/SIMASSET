  ...
  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
      ...
      <ul class="nav side-menu">
        ...
        <li><a href="{{route('home.dashboard')}}"><i class="fa fa-home  "></i>Home </a>
    ...
    <div class="menu_section">
      <h3>KIB</h3>
      <ul class="nav side-menu">
          <li class="active"><a><i class="fa fa-folder-open"></i>Kartu Inventaris Barang  <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu" style="display: block;" id="menukib">
               <li> <a href="{{route('aset.index',['data=2'])}}">KIB Tanah</a> </li>
               <li> <a href="{{route('aset.index',['data=4'])}}">KIB Gedung dan Bangunan</a> </li>
               <li> <a href="{{route('aset.index',['data=3'])}}">KIB Peralatan dan Mesin</a> </li>
               <li> <a href="{{route('aset.index',['data=5'])}}">KIB Jalan, Irigasi dan Jaringan</a> </li>
            </ul>
          </li>
