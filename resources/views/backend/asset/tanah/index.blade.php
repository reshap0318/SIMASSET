    ...
    <div class="x_panel tile fixed_height">
                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{route('tanah.index',['data'=>$data_master, 'lok' => '1'])}}" class="btn btn-warning pull-right">Lihat</a>
                        </div>
                    </div>
                </div>
        </div>
         ...
         <div class="col-md-4 col-sm-4 col-xs-12">
            ...
            <div class="x_content">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="{{route('tanah.index',['data'=>$data_master, 'lok' => '2'])}}" class="btn btn-warning pull-right">Lihat</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="x_panel tile fixed_height">
        ...
        <div class="x_content">
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="{{route('tanah.index',['data'=>$data_master, 'lok' => '3'])}}" class="btn btn-warning pull-right">Lihat</a>
                </div>
            </div>
        </div>
        </div>
