                          ...
                          <td class=" last">
                              ...
                              <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu pull-right">
                                  <li><a class="btn dropdown-item" href="{{route('pemeliharaan.create',['asset_id='.$dat->id])}}">Pemeliharaan</a></li>
                                  <li><a class="btn dropdown-item" href="{{route('pemanfaatan.create',['asset_id='.$dat->id])}}">Pemanfaatan</a></li>
                                  <li><a class="btn dropdown-item" href="{{route('page.pemindah_tanganan')}}">Pengguna</a></li>
                                </ul>
                              </div>
                                  </center>
                              @endif
