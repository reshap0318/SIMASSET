...
<div class="form-group">
    {!! Form::label('no_gegistrasi', 'No Registrasi *', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
...
<div class="form-group col-sm-12">
    <div id="map-content" style="width:100%;height:420px; z-index:50"></div> <br> <br>
    <a class="btn btn-primary btn-sm" id="delete-button">Delete</a> <br> <br>
