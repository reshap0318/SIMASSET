...
@section('content')
    ...
    <div class="row">
            ...
            <div class="x_panel tile fixed_height">
                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{route('airJaringan.index',['data'=>$data_master, 'lok' => '1'])}}" class="btn btn-primary pull-right">Lihat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="x_panel tile fixed_height">
                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{route('airJaringan.index',['data'=>$data_master, 'lok' => '2'])}}" class="btn btn-primary pull-right">Lihat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="x_panel tile fixed_height">
                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{route('airJaringan.index',['data'=>$data_master, 'lok' => '3'])}}" class="btn btn-primary pull-right">Lihat</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel tile fixed_height">
                <div class="x_title">
                    <a href=""><h3>Daftar Air & Jaringan</h3></a>
                    <ul class="nav navbar-right panel_toolbox">
                ...
                <div class="x_content">
                    <table class="table table-bordered table-striped table-hover" id="tblaset">
                        ...
                        @foreach($datas as $dat)
                            ...
                            $pdg = DB::select('Select count(kd_brg) as GroupKota from asset join air_jaringan on air_jaringan.id=asset.id where kd_brg= ? and (kd_kab = 855 or kd_kab= 800)',[$dat->kd_brg]);
                            $pyk = DB::select('Select count(kd_brg) as GroupKota from asset join air_jaringan on air_jaringan.id=asset.id where kd_brg= ? and (kd_kab = 856 or kd_kab= 803) ',[$dat->kd_brg]);
                            $dmr = DB::select('Select count(kd_brg) as GroupKota from asset join air_jaringan on air_jaringan.id=asset.id where kd_brg= ? and (kd_kab = 0) ',[$dat->kd_brg]);
//                                                      dd($dat->kd_brg);
                            ?>
