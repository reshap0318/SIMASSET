...
@section('content')
  <div class="x_panel">
    <div class="x_title">
      <h2>Asset Tanah Unand <small>List</small></h2>
      <ul class="nav navbar-right panel_toolbox">
        @if (Sentinel::getUser()->hasAccess(['role.create']))
          <a href="{{route('asset.create')}}" class="btn btn-success">New Tanah</a>
        @endif
      </ul>
  ...
  <table class="table table-bordered table-striped table-hover" id="tblRole">
    ...
    <tbody>
      <tr>
        ...
        <td class=" ">Tanah Limau Manis</td>
        <td class=" last">
           <a href="#" class="btn btn-success btn-xs">Lokasi Tanah</a>
          @if (Sentinel::getUser()->hasAccess(['asset.show']))
